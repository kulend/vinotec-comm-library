...
import cn.vinotec.app.android.comm.https.CustomHttpClient;
import cn.vinotec.app.android.comm.https.CustomHttpURLConnection;
import cn.vinotec.app.android.comm.https.NetWorkHelper;
...
public class HttpUtils {
	...
	public static String postByHttpClient(Context context, String strUrl, MultipartEntity entity)
	{
		return CustomHttpClient.PostFromWebByHttpClient(context, strUrl, entity);
	}
