...
public class VinoEventListener implements View.OnClickListener, View.OnLongClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemSelectedListener,AdapterView.OnItemLongClickListener {
    ...
    public VinoEventListener(Object handler) {
        this.handler = handler;
    }

    public VinoEventListener click(String method){
        this.clickMethod = method;
        return this;
    }

    public VinoEventListener longClick(String method){
        this.longClickMethod = method;
        return this;
    }

    public VinoEventListener itemLongClick(String method){
        this.itemLongClickMehtod = method;
        return this;
    }

    public VinoEventListener itemClick(String method){
        this.itemClickMethod = method;
        return this;
    }

    public VinoEventListener select(String method){
        this.itemSelectMethod = method;
        return this;
    }

    public VinoEventListener noSelect(String method){
